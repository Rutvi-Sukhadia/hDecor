...
public class FTPUtils {
	...
	public static void download(String remoteFilename, String downloadFileName) {
		String server = ConfigProperties.getFtpServer();
		int port = ConfigProperties.getFptPort();
		String user = ConfigProperties.getFtpUserName();
		String pass = ConfigProperties.getFtpPassword();
