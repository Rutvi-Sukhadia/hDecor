					...
					<div class="col-xs-12">
						<div class="box">
							...
							<form:form role="form" modelAttribute="state"
								action="/hdecorAdmin/state/saveState" method="post">
								<div class="box-body">
									...
									<div class="box-footer">
										<center>
											...
											<a href="/hdecorAdmin/state/stateList"><button
								...
								<tbody>
									<c:forEach var="s" items="${liststate}">
										...
										<tr>
											...
											                                         
											<td>                        <a
												href="/hdecorAdmin/state/editState/<c:out value='${s.stateId}' />">Edit</a>
												                        &nbsp;&nbsp;&nbsp;&nbsp;
												                        <a
												href="/hdecorAdmin/state/deleteState/<c:out value='${s.stateId}' />">Delete</a>                     
												                    
											</td>
										</tr>
									</c:forEach>
