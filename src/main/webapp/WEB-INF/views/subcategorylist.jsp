...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<form:form role="form" modelAttribute="subcategory"
								action="/hdecorAdmin/subcategory/saveSubcategory" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="subcategoryId"
											placeholder="" path="subcategoryId" />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<form:input type="text" class="form-control" id="subcategoryName"
											placeholder="Subcategory Name" path="subcategoryName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/hdecorAdmin/subcategory/subcategoryList"><button
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<c:forEach var="c" items="${listsubcategory}">
											...
											<tr>
												<td><c:out value="${c.subcategoryId}" /></td>
												                    
												<td><c:out value="${c.subcategoryName}" /></td>
												                    
												<td><c:out value="${c.parentCategoryName}" /></td>                                         
												<td>                        <a
													href="/hdecorAdmin/subcategory/editSubcategory/<c:out value='${c.subcategoryId}' />">Edit</a>
													                        &nbsp;&nbsp;&nbsp;&nbsp;
													                        <a
													href="/hdecorAdmin/subcategory/deleteSubcategory/<c:out value='${c.subcategoryId}' />">Delete</a>                     
													                    
												</td>
											</tr>
										</c:forEach>
	...
	<!-- DataTables -->
	<script
		src="/hdecorAdmin/resources/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
	<script
		src="/hdecorAdmin/resources/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
	<!-- SlimScroll -->
	<script
