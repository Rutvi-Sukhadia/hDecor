					...
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<form:form role="form" modelAttribute="area"
								action="/hdecorAdmin/area/saveArea" method="post">
								<div class="box-body">
									...
									<div class="row">
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<form:select class="form-control select2"
													style="width: 100%;" id="stateId" path="stateId">
										...
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<form:select class="form-control select2"
													style="width: 100%;" id="citiesByState" path="cityId">
									...
									<div class="box-footer">
										<center>
											...
											<a href="/hdecorAdmin/area/areaList"><button type="reset"
									...
									<tbody>
										<c:forEach var="a" items="${listarea}">
											...
											<tr>
												...
												                    
												<td>                        <a
													href="/hdecorAdmin/area/editArea/<c:out value='${a.areaId}' />">Edit</a>
													                        &nbsp;&nbsp;&nbsp;&nbsp;
													                        <a
													href="/hdecorAdmin/area/deleteArea/<c:out value='${a.areaId}' />">Delete</a>                     
													                    
												</td>
											</tr>
										</c:forEach>
				...
				.change(
						function() {
							...
							$
									.ajax({
										type : 'GET',
										url : "/hdecorAdmin/area/getCities/"
												+ stateId,
