				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<form:form role="form" modelAttribute="category"
								action="/hdecorAdmin/category/saveCategory" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="categoryId"
											placeholder="" path="categoryId" />
									</div>

									<div class="form-group">
										<label for="exampleInputEmail1">Category Name</label>
										<form:input type="text" class="form-control" id="categoryName" placeholder="Category Name" path="categoryName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/hdecorAdmin/category/categoryList"><button
								...
								<tbody>
									<c:forEach var="s" items="${listcategory}">
										...
										<tr>
											...
											                                         
											<td>                        <a
												href="/hdecorAdmin/category/editCategory/<c:out value='${s.categoryId}' />">Edit</a>
												                        &nbsp;&nbsp;&nbsp;&nbsp;
												                        <a
												href="/hdecorAdmin/category/deleteCategory/<c:out value='${s.categoryId}' />">Delete</a>                     
												                    
											</td>
										</tr>
									</c:forEach>
