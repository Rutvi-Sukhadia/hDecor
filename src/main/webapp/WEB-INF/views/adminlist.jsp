	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Admin List</h1>
				<ol class="breadcrumb">
					<li><a href="/hdecorAdmin/admin/addAdmin"><button
								class="btn btn-primary">Add New Admin</button></a></li>
				</ol>
									...
									<tbody>
										<c:forEach var="ad" items="${listadmin}">
											...
											<tr>
												...
												                                         
												<td>                        <a
													href="/hdecorAdmin/admin/editAdmin/<c:out value='${ad.adminId}' />">Edit</a>
													                        &nbsp;&nbsp;&nbsp;&nbsp;
													                        <a
													href="/hdecorAdmin/admin/deleteAdmin/<c:out value='${ad.adminId}' />">Delete</a>                     
													                    
												</td>
											</tr>
										</c:forEach>
