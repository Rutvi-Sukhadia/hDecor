					...
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<form:form role="form" modelAttribute="city"
								action="/hdecorAdmin/city/saveCity" method="post">
								<div class="box-body">
									...
									<div class="box-footer">
										<center>
											...
											<a href="/hdecorAdmin/city/cityList"><button
									...
									<tbody>
										<c:forEach var="c" items="${listcity}">
											...
											<tr>
												...
												<td>                        <a
													href="/hdecorAdmin/city/editCity/<c:out value='${c.cityId}' />">Edit</a>
													                        &nbsp;&nbsp;&nbsp;&nbsp;
													                        <a
													href="/hdecorAdmin/city/deleteCity/<c:out value='${c.cityId}' />">Delete</a>                     
													                    
												</td>
											</tr>
										</c:forEach>
