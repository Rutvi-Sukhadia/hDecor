				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<form:form role="form" modelAttribute="material"
								action="/hdecorAdmin/material/saveMaterial" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="materialId"
											placeholder="" path="materialId" />
									</div>

									<div class="form-group">
										<label for="exampleInputEmail1">Material Name</label>
										<form:input type="text" class="form-control" id="materialName" placeholder="Material Name" path="materialName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/hdecorAdmin/material/materialList"><button
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach var="s" items="${listmaterial}">

										<tr>
											<td><c:out value="${s.materialId}" /></td>
											                    
											<td><c:out value="${s.materialName}" /></td>
											                                         
											<td>                        <a
												href="/hdecorAdmin/material/editMaterial/<c:out value='${s.materialId}' />">Edit</a>
												                        &nbsp;&nbsp;&nbsp;&nbsp;
												                        <a
												href="/hdecorAdmin/material/deleteMaterial/<c:out value='${s.materialId}' />">Delete</a>                     
												                    
											</td>
										</tr>
									</c:forEach>
