					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Color Form</h3>
							</div>
							<form:form role="form" modelAttribute="color"
								action="/hdecorAdmin/color/saveColor" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="colorId"
											placeholder="" path="colorId" />
									</div>

									<div class="form-group">
										<label for="exampleInputEmail1">Color Name</label>
										<form:input type="text" class="form-control" id="colorName" placeholder="Color Name" path="colorName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/hdecorAdmin/color/colorList"><button
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach var="s" items="${listcolor}">

										<tr>
											<td><c:out value="${s.colorId}" /></td>
											                    
											<td><c:out value="${s.colorName}" /></td>
											                                         
											<td>                        <a
												href="/hdecorAdmin/color/editColor/<c:out value='${s.colorId}' />">Edit</a>
												                        &nbsp;&nbsp;&nbsp;&nbsp;
												                        <a
												href="/hdecorAdmin/color/deleteColor/<c:out value='${s.colorId}' />">Delete</a>                     
												                    
											</td>
										</tr>
									</c:forEach>
